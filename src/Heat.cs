...
namespace uMod.Heat
{
    ...
    public partial class Heat : CSPlugin
    {
        ...
        private void Init()
        {
            ...
            AddUniversalCommand(new[] { "umod.quit", "u.quit", "quit" }, nameof(QuitCommand));
        ...
        {
            string format = player.IsServer ? Formatter.ToPlaintext(lang.GetMessage("Version", this, player.Id)) : Universal.FormatText(lang.GetMessage("Version", this, player.Id));
